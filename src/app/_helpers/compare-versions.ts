import { AppVersionDTO } from "@interfaces/home/i-app-version";
...
export function getCurrentAppVersion(appsVersion: AppVersionDTO[]): string{
  return appsVersion.find(v => v.description == "Doctor Portal Version")?.version
}
